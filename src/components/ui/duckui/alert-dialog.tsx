...
interface AlertDialogDrawerContentType
  extends Partial<React.ComponentPropsWithoutRef<typeof DrawerContent>> {}
interface AlertDialogDrawerTriggerentType
  extends Partial<React.ComponentPropsWithoutRef<typeof DrawerTrigger>> {}
interface StateType {
  drawer: boolean;
  alert: boolean;
}
...
interface AlertDialogDrawerHeaderType
  extends Partial<React.ComponentPropsWithoutRef<typeof DrawerHeader>> {
                ...
                (footerChildren ? (
                  ...
                  >
                    ...
                    <Button
                      ...
                      className={cn("!ml-0 p-0 w-fit h-fit")}
                      {...submitProps}
                    >
                      {submitChildren}
                    </Button>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This action will consider these replies as Drafts, you can delete,
              adjust and send from Drafts section on the side header.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
