...
import { useDuckShortcut } from "@/lib/duck-shortcut";

export type IconType = { icon: LucideIcon } & IconProps &
...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const fn = () =>
      console.log("NOTE: handling command shortcut without action");
            ...
            {!isCollapsed &&
              ...
              (type == "default" ? (
                ...
                <Badge
                  ...
                  size={"icon"}
                  className={cn(
                    "size-5 text-[.6rem] absolute top-0 right-0",
                    labelClassName,
                  )}
                  {...labelProps}
                >
