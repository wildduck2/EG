            ...
            {filters.map((item, i) => (
                <li key={i}>
                    <Button
                        variant="outline"
                        className={cn(
                            "text-[#ee1d24] font-semibold border cursor-pointer px-5 py-1 rounded-md border-[#ee1d24] hover:bg-[#ee1d24] hover:text-white",
                            currentFilter === item.category && "bg-[#ee1d24] text-accent",
                        )}
